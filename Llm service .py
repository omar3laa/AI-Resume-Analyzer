...
# نستخدم alias "gemini-flash-latest" بدل اسم إصدار مثبت (زي gemini-2.5-flash)
# عشان يتأشر تلقائيًا على أحدث موديل Flash مستقر متاح من جوجل،
# وميتوقفش الكود لما جوجل توقف إصدار قديم عن العمل.
